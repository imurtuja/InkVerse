  ...
  return (
    <>
      <article 
        ...
        className="group bg-white/[0.02] border border-white/10 shadow-xl shadow-black/40 rounded-2xl overflow-hidden transition-colors duration-200 text-gray-100 cursor-pointer max-w-3xl mx-auto w-full hover:bg-black/20"
      >
